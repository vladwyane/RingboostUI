 ...
 */
public class CategoryTollFree extends BasePage {

    public CategoryTollFree(WebDriver driver) {
        super(driver);
    }

    @Override
    public void open() {
        driver.get(ConfigProperties.getProperty("adminCategoryTollFree.url"));
    }
    ...
    public void fillNewCategoryForm(CategoriesData categoriesData) {
        ...
        choosePhoneType(categoriesData.getPhoneType());
    }
    ...
    public void checkingErrorMessagesAllFieldsIsEmpty() {
        ...
        softAssert.assertEquals(newCategoryPopup.getListOfErrorMessage().get(3).getText(), "The type field is required.");
