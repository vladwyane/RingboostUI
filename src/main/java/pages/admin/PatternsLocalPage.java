 ...
 */
public class PatternsLocalPage extends BasePage {

    public PatternsLocalPage(WebDriver driver) {
        super(driver);
    }

    @Override
    public void open() {
        driver.get(ConfigProperties.getProperty("adminPatternsLocal.url"));
    }
    ...
    public void searchPattern (String searchRequest) {
        ...
        patternsTable.getSearchField().sendKeys(Keys.ENTER);
        waiting2seconds();
    }
